  ...
  return (
    <div className="p-4 flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-1">
        <p className="mb-1 text-xs font-semibold uppercase tracking-[0.12em] text-zinc-500">{t('deep.concepts')}</p>
      ...
      {weakPoints.length > 0 && (
        <div>
          <p className="mb-1 text-xs font-semibold uppercase tracking-[0.12em] text-zinc-500">{t('deep.weakPoints')}</p>
          <div className="flex flex-col gap-1">
            {weakPoints.map((w, i) => (
