...
export default function NotesSuggestionToast({ suggestion, onAdd, onDismiss }) {
  ...
  return (
    <div className="apple-card fixed bottom-6 right-6 z-40 max-w-md rounded-[20px] p-4 shadow-[var(--shadow-float)]">
      ...
      <div className="flex gap-2 mt-3 justify-end">
        ...
        <button
          ...
          className="rounded-full bg-[#007AFF] px-3 py-1 text-xs font-semibold text-white"
        >
          {t('deep.note.add')}
        </button>
      </div>
